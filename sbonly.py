...
jaka = ["uacd6fa31c6926ac180e070aeb6131c87"]
creator = ["uacd6fa31c6926ac180e070aeb6131c87","u05ac5e80ee95c6a8b4beb1ce30b0779b"]
owner = ["uacd6fa31c6926ac180e070aeb6131c87","u05ac5e80ee95c6a8b4beb1ce30b0779b"]
admin = ["uacd6fa31c6926ac180e070aeb6131c87","u05ac5e80ee95c6a8b4beb1ce30b0779b"]
staff = ["uacd6fa31c6926ac180e070aeb6131c87","u05ac5e80ee95c6a8b4beb1ce30b0779b"]
...
wait = {
    ...
    "comment1": "ᴀᴜᴛᴏ ʟɪᴋᴇ ɴ ᴄᴏᴍᴍᴇɴᴛ ᴅᴏɴᴇ\nвʏ.ᴛᴇᴀᴍ ⊶ ɪɴᴇxʙᴏᴛs ⊷ \nline.me/ti/p/~shahzain83",
    "comment2": "╭━━━━━━━━━━━━━━━━━━━━━━━━\n┃ ╔══════════════════━━━━╮\n┃ ║   ❀     BY BOT : [̲̅S̲̅][̲̅Q̲̅][̲̅U̲̅][̲̅A̲̅][̲̅D̲̅]    ❀\n┃ ╚══════════════════━━━━╯\n├━━━━━━━━━━━━━━━━━━━━━━━━\n┃ ╔══════════════════━━━━╮\n┃ ║  ❀ LIKE DONE \n┃ ║  ❀ COMMENT DONE \n┃ ║  ❀ [̲̅S̲̅][̲̅Q̲̅][̲̅U̲̅][̲̅A̲̅][̲̅D̲̅]_TEAM\n┃ ╚══════════════════━━━━╯\n├━━━━━━━━━━━━━━━━━━━━━━━━\n┃ ╔══════════════════━━━━╮\n┃ ║  http://line.me/ti/p/~shahzain83\n┃ ╚══════════════════━━━━╯\n╰━━━━━━━━━━━━━━━━━━━━━━━━",
    ...
    "contents": [
      {
        "contents": [
          {
            "text": "    [̲̅S̲̅][̲̅Q̲̅][̲̅U̲̅][̲̅A̲̅][̲̅D̲̅]",
            "size": "xs",
            "color": "#00FF33",
            "wrap": True,
            "weight": "bold",
...
def sendTextTemplate5(to, text):
    ...
    data = {
            "type": "flex",
            "altText": "[̲̅S̲̅][̲̅Q̲̅][̲̅U̲̅][̲̅A̲̅][̲̅D̲̅]",
            "contents": {
  "type": "bubble",
  "body": {
    "type": "box",
...
def media():
    ...
    key = key.title()
    helpMedia   = "      ━──────────────━\n"
    helpMedia += "╔" + "━═[ 🇮🇩[̲̅S̲̅][̲̅Q̲̅][̲̅U̲̅][̲̅A̲̅][̲̅D̲̅]🇮🇩]═━╗\n"
                ...
                "contents": [
                    ...
                    },
                    {
                        ...
                        "contents": [
                            {
                                "type": "text",
                                "text": "[̲̅S̲̅][̲̅Q̲̅][̲̅U̲̅][̲̅A̲̅][̲̅D̲̅]_V1",
                                "color": "#F7141F",
                                "flex": 1,
                                "gravity": "center",
                                "action": {
                            ...
                            {
                                "type": "text",
                                "text": "[̲̅S̲̅][̲̅Q̲̅][̲̅U̲̅][̲̅A̲̅][̲̅D̲̅]_V2",
                                "color": "#81FF00",
                                "flex": 1,
                                "gravity": "center",
                                "action": {
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in jaka:
                            try:
                                ...
                                bot = runtime(eltime)
                                start = time.time()
                                #cl.sendText("u05ac5e80ee95c6a8b4beb1ce30b0779b", '.')
                                ...
                                #ret10_ += "│ ❀ [̲̅S̲̅][̲̅Q̲̅][̲̅U̲̅][̲̅A̲̅][̲̅D̲̅]"
        ...
        "align": "center"
                          ...
                          if msg._from in owner or msg._from in admin:
                            ...
                            try:
                                ...
                                ret_ += "Team [̲̅S̲̅][̲̅Q̲̅][̲̅U̲̅][̲̅A̲̅][̲̅D̲̅] Grup Info\n"
